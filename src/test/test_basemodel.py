...
class TestBaseModel(unittest.TestCase):
    ...
    def test_isValid(self):
        # What do I test when the parameter data is not even being used, and we just return True
        pass

    def test_get_item(self):
        # How do I get the table name to be what I want?
        # guess this method only works for the specific primary key generated by rethinkdb
        #try:
        #    print(BaseModel().get_item('user_id'))
        #except:
        #    self.fail('Error: I guess get_item doesnt work')
        pass
